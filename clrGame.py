...
def helpMe():
    popup = tk.Tk()
    popup.wm_title("Help")
    label = tk.Label(popup, text="Ohjeet")
    label.pack(side="top", fill="x", pady=10)
    label2 = tk.Label(popup, text="G = Vihreä\nR = Punainen\nB = Sininen\nY = Keltainen\n\nTutorial:\nOranssille taustalle tulee teksti.\nEsim. GRY\nSinun pitää painaa Vihreä Punainen Keltainen.\nHuomaat että sinun pitää muistaa väri koodi\nKoska se katoaa")
